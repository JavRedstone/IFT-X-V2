...
Command: npx @threlte/gltf@2.0.3 C:\DuDu\Olympiads_School\Computer\Websites\IFT-X\IFT-X\static\models\rvac.glb --root /models/ --types --printwidth 120 --precision 2
-->
