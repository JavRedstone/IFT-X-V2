export class CelestialConstants {
    ...
    public static readonly MOON_RADIUS: number = this.EARTH_RADIUS * 0.27;
    public static readonly MOON_DISTANCE: number = this.EARTH_RADIUS * 60;
    public static readonly MOON_ORBIT_SPEED: number = this.EARTH_ROTATION_SPEED / 27.3;
