...
export class StarshipConstants {
    ...
    public static readonly SHIP_RING_SCALE: Vector3 = new Vector3(1, 3/4*50/4.5, 1);
    
    public static readonly FORWARD_L_SCALE: Vector3 = new Vector3(0.033610, 0.033610, 0.033610);
    public static readonly FORWARD_L_ROTATION: Euler = new Euler(12.8405, 0, 0);
    public static readonly FORWARD_R_SCALE: Vector3 = new Vector3(0.033610, 0.033610, 0.033610);
    public static readonly FORWARD_R_ROTATION: Euler = new Euler(-12.8405, 0, 0);
    ...
    public static readonly R_SEA_RADIUS: number = 0.2 * StarshipConstants.STARSHIP_RADIUS;
    ...
    public static readonly R_VAC_RADIUS: number = 0.6 * StarshipConstants.STARSHIP_RADIUS;
