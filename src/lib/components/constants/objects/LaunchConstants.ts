export class LaunchConstants {
    public static readonly AABB_REQUEST_AMOUNT: number = 4;
    public static readonly AABB_REQUEST_MAX: number = 16;
    ...
    // public static readonly FUELING_SPEEDUP: number = 250;
    public static readonly FUELING_SPEEDUP: number = 10000;
