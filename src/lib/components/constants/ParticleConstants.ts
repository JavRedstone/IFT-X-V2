export class ParticleConstants {
    ...
    public static readonly RAPTOR_FORCE_MULTIPLIER: number = 100;
    public static readonly RAPTOR_A_SCALE: number = 1;
    public static readonly RAPTOR_B_SCALE: number = 1.5;
    public static readonly RAPTOR_SEA_TO_VAC: number = 1.5;
    public static readonly RAPTOR_ALTITUDE_MULTIPLIER: number = 0.0000075;
